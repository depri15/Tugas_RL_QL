...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        # Obstacle 3
        self.obstacle3 = self.canvas_widget.create_image(0, pixels * 8, anchor='nw', image=self.obstacle5_object)
        # Obstacle 4
        ...
        # Obstacle 6
        self.obstacle6 = self.canvas_widget.create_image(pixels, pixels * 3, anchor='nw', image=self.obstacle7_object)
        # Obstacle 7
        ...
        # Obstacle 9
        self.obstacle9 = self.canvas_widget.create_image(pixels * 5, pixels * 8, anchor='nw', image=self.obstacle4_object)
        # Obstacle 10
        self.obstacle10 = self.canvas_widget.create_image(pixels * 6, pixels * 8, anchor='nw', image=self.obstacle4_object)
        # Obstacle 11
        ...
        # Obstacle 13
        self.obstacle13 = self.canvas_widget.create_image(0, pixels * 3, anchor='nw', image=self.obstacle3_object)
        # Obstacle 14
        self.obstacle14 = self.canvas_widget.create_image(pixels, pixels * 6, anchor='nw', image=self.obstacle8_object)
        # Obstacle 15
        ...
        # Obstacle 18
        self.obstacle18 = self.canvas_widget.create_image(pixels * 3, pixels * 7, anchor='nw', image=self.obstacle11_object)
        # Obstacle 19
        ...
        # Obstacle 21
        self.obstacle21 = self.canvas_widget.create_image(pixels * 7, pixels * 8, anchor='nw', image=self.obstacle4_object)
        # Obstacle 22
        self.obstacle22 = self.canvas_widget.create_image(pixels * 4, pixels * 3, anchor='nw', image=self.obstacle2_object)

        # Final Point
        img_flag = Image.open("images/flag.png")
        self.flag_object = ImageTk.PhotoImage(img_flag)
        self.flag = self.canvas_widget.create_image(pixels * 6, pixels * 2, anchor='nw', image=self.flag_object)
        ...
        self.agent = self.canvas_widget.create_image(pixels, pixels * 8, anchor='nw', image=self.robot)
